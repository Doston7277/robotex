                    ...
                    <div class="col-lg-9">
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('front/assets/images/blog/post-1.jpg') }}" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media entry-video">
                                <a href="single.html">
                                    <img src="{{ asset('front/assets/images/blog/post-2.jpg') }}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl">
                                    <a href="single.html">
                                        <img src="{{ asset('front/assets/images/blog/post-3.jpg') }}" alt="image desc">
                                    </a>
                                    <a href="single.html">
                                        <img src="{{ asset('front/assets/images/blog/post-2.jpg') }}" alt="image desc">
                                    </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('front/assets/images/blog/post-4.jpg') }}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('front/assets/images/blog/post-5.jpg') }}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                ...
                                <ul class="posts-list">
                                    <li>
                                        <figure>
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/blog/sidebar/post-1.jpg') }}" alt="post">
                                            </a>
                                        </figure>
                                    ...
                                    <li>
                                        <figure>
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/blog/sidebar/post-2.jpg') }}" alt="post">
                                            </a>
                                        </figure>
                                    ...
                                    <li>
                                        <figure>
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/blog/sidebar/post-3.jpg') }}" alt="post">
                                            </a>
                                        </figure>
                                    ...
                                    <li>
                                        <figure>
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/blog/sidebar/post-4.jpg') }}" alt="post">
                                            </a>
                                        </figure>
                            ...
                            <div class="widget widget-banner-sidebar">
                                ...
                                <div class="banner-sidebar banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('front/assets/images/blog/sidebar/banner.jpg') }}" alt="banner">
                                    </a>
                                </div><!-- End .banner-ad -->
                            </div><!-- End .widget -->
